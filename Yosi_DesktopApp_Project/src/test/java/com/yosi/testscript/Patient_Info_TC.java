...
public class Patient_Info_TC extends YosiBaseClass{
	...
	//Patient_Info_POM patient_Info_POM = PageFactory.initElements(driver, Patient_Info_POM.class);
	 ...
	 @BeforeClass
	  public void beforeClass() throws InterruptedException {
		...
		// startTest();
		 ...
		 extent
		                ...
		                extent.loadConfig(new File(System.getProperty("user.dir")+"C:/Users/Dreams/eclipse-workspace/Yosi_DesktopApp_Project/extent-config.xml"));
		  desktop_init();
		  start_paperwork();
		  select_doctor();
		  verify_patient();		           
	  ...
	  public Object[][] dp() throws Exception{
		 // C:\Users\Dreams\eclipse-workspace\Yosi_DesktopApp_Project\src\main\java\com\yosi\testdata\
		 String file_location = "C:/Users/Dreams/eclipse-workspace/Yosi_DesktopApp_Project/src/main/java/com/yosi/testdata/TestData.xlsx";
  ...
  {		
	...
	//String fname = patient_Info_POM.getPat_info_fname();
	...
	//String add=patient_Info_POM.setPat_info_address1(address1);
		driver.findElement(By.id("address1")).click();
		driver.findElement(By.id("address1")).clear();
		driver.findElement(By.id("address1")).sendKeys(address1);
		
		//patient_Info_POM.setPat_info_address1(address1);
		//System.out.println(patient_Info_POM.setPat_info_address1(address1));
		//patient_Info_POM.setPat_info_address1(address1);
